...
public class CollectionFactory {
	...
	public static List<Integer> getIntegerList(){
		...
		integers.add(Integer.valueOf(70));
		integers.add(120);
		integers.add(Integer.valueOf(80));
		integers.add(Integer.valueOf(60));
		integers.add(40);
		return integers;
	...
	public static List<Double> getDoubleList(){
		...
		doubles.add(2000.00);
		doubles.add(2400.00);
		doubles.add(Double.valueOf(1800));
		doubles.add(600.00);
		doubles.add(2600.00);
		doubles.add(Double.valueOf(400));
